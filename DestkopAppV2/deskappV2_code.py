...
# Form implementation generated from reading ui file 'destkop_app_v2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toodle.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/aybuIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/settAsset 50.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/cleanAsset 59.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/homeAsset 46.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/ctIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icons/mrIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icons/resultIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/aboutIconv2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.lbl_ybu_icon.setPixmap(QtGui.QPixmap("icons/aybuIcon.png"))
